"""
FLAC Index Backend Module
========================

Low-level FLAC frame parsing and index creation functions.
This module is called internally by flac_access.py and should not be used directly.

Functions:
- Frame parsing and sync detection
- Index array creation and management
- Low-level FLAC header parsing
"""
...
logger.trace("FLAC Index Backend module loading...")
...
def build_flac_index(zarr_group: zarr.Group, audio_blob_array: zarr.Array) -> zarr.Array:
    ...
    # Extract metadata from array attributes (set by flac_access.py)
...
logger.trace("FLAC Index Backend module loaded.")